...
<u>Т3</u> (Необходимое условие экстремума функционала с двумя подвижными границами)
    ...
    Тогда: $y(x)$ удовлетворяет уравнению Эйлера: $F_y' - \frac{d}{dx} F_p' = 0$ с дополнительными условиями $(6)$, а на обоих концах выполняется условие трансверсальности:
$$(F - (y' - \phi'(x))F_p') \mid_{x=x_2} = 0$$
$$(F - (y' - \psi'(x))F_p') \mid_{x=x_1} = 0$$
...
Значит:
$x = c_1 - \frac{\lambda p}{\sqrt{1 + p^2}}$, $y = c_2 + \frac{\lambda}{\sqrt{1 + p^2}}$
Исключим $p$:
